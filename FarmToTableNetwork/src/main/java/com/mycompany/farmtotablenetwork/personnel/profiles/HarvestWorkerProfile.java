 ...
 */
public class HarvestWorkerProfile extends Profile {
    
    public HarvestWorkerProfile(Person person, Organization organization) {
        super(person, "Harvest Worker", organization);
    }

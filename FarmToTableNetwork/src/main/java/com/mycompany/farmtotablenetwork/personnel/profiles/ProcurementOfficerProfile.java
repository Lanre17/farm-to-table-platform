 ...
 * @author Lanre
 */
public class ProcurementOfficerProfile extends Profile {
    // Retail role for creating and managing purchase orders
    public ProcurementOfficerProfile(Person person, Organization organization) {
        super(person, "Procurement Officer", organization);
    }
}

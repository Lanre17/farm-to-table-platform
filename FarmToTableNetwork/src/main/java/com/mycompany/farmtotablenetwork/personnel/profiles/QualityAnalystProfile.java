 ...
 */
public class QualityAnalystProfile extends Profile {
    public QualityAnalystProfile(Person person, Organization organization) {
        super(person, "Quality Analyst", organization);
    }    
}
